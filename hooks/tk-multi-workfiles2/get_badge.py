...
class GetBadge(HookClass):
    ...
    def get_publish_badge(self, publish_details, publish_path, **kwargs):
        ...
        :returns: A QPixmap or QColor to use for the badge, if a badge should be applied, otherwise
            ...
            color.
        """
        self.logger.debug("publish_details: {}".format(str(publish_details)))
        self.logger.debug("publish_path: {}".format(str(publish_path)))
    ...
    def get_work_file_badge(self, work_file_details, work_file_path, **kwargs):
        ...
        """
        # the default implementation always returns None.
        self.logger.debug("work_file_details: {}".format(work_file_details))
        self.logger.debug("work_file_path: {}".format(work_file_path))

        icon = os.path.join(self.disk_location, "icons", "editable.png")
